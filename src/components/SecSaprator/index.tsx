...
const SectionSaprator = (props: any) => {
  return (
    <div className="section-saprator flex flex-row items-center mb-6 mt-[88px] overflow-hidden mw-xl:m-0	mw-xl:py-8 mw-sm:py-5">
      <p className="text-brandDark2 font-bold font-sec-saprate-18 dark:text-secSaprator w-auto min-w-fit mw-sm:pt-5 mw-sm:border-t-2 border-t-brandLightOpacity10 mw-sm:w-full uppercase">
        {props.title}
      </p>
