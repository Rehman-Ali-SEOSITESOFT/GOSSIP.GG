...
const AbsBannerArticle = (props: any) => {
  ...
  return (
    <>
      <section className="article_banner_wrapper">
          ...
          <div className="w-[calc(100%_-_0px)] mw-lg:w-[calc(100%_-_0px)] mx-14:w-[70%]">
            <div className="w-full">
              ...
              <div className="pr-[25px] mw-md:pr-[0px]  ">
                <p className="robotoslub text-[16px] leading-[27px] tracking-[0.03em] dark:text-brandLightOpacity90 font-normal mw-md:text-[14px] mw-md:leading-[24px] pt-[40px] mw-lg:pt-[30px]">
                ...
                <h2 className="pt-[40px] pb-[24px] montserratfont text-[24px] leading-[30px] tracking-[0.05em] capitalize dark:text-[#E5E5E5] font-bold mw-md:pb-[20px] mw-md:pt-[20px] mw-md:text-[20px] mw-md:leading-[26px]">
                  Floo flames - a new feature
                </h2>
                <p className="pb-[24px] robotoslub text-[16px] leading-[27px] tracking-[0.03em] dark:text-brandLightOpacity90 font-normal mw-md:text-[14px] mw-md:leading-[24px]  ">
                  Lorem Ipsum is simply dummy text of the printing and
                  typesetting industry. Lorem Ipsum has been the industry's
                  standard dummy text ever since the 1500s, when an unknown
                  printer took a galley of type and scrambled it to make a type
                ...
                <p className="robotoslub text-[16px] leading-[27px] tracking-[0.03em] dark:text-brandLightOpacity90 font-normal mw-md:text-[14px] mw-md:leading-[24px]">
                  Lorem Ipsum is simply dummy text of the printing and
                  typesetting industry. Lorem Ipsum has been the industry's
                  standard dummy text ever since the 1500s, when an unknown
                  printer took a galley of type and scrambled it to make a type
