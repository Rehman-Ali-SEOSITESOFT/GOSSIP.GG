              ...
              <div className="flex flex-col  h-full">
                ...
                <div className="mx-[16px] mt-[24px]">
                  ...
                  <div className="text-left p-[12px] w-[343px] h-[227px] dark:bg-brandLightOpacity5 border-[1px] border-brandLightOpacity10 rounded mt-[20px]">
                    ...
                    <p className="montserratfont dark:text-brandLightOpacity100 text-[14px] font-light">Abc road near abc bank</p>
                    <p className="montserratfont dark:text-brandLightOpacity100 text-[14px] font-light">Indiranagar</p>
                    <p className="montserratfont dark:text-brandLightOpacity100 text-[14px] font-light">Bengaluru, Karnatka 560037 </p>
