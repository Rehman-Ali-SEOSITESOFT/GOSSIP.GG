...
import "./gamingLowerContent.css";
import Image from "next/image";
const GamingLowerContent = (props: any) => {
    ...
    <>
      <div className="content_wrapper flex dark:bg-[#2E2A2B] my-[20px] rounded dark:border-[0px] border">
        ...
        <div className="content-right pr-[13px] pl-[13px] pt-[10px] pb-[10px]">
          ...
          <div className="bottom_section flex mt-[6px] justify-between mx-13:mt-[14px]	items-end">
...
export default GamingLowerContent;
