...
import GamingLatest from "./GamingLatest";
...
import GamingTrendingTags from "./GamingTrendingTags";
const GamingLatestHeroTrending = () => {
  interface LATEST {
    image: any;
    latestNew: String;
  }
...
export default GamingLatestHeroTrending;
