      ...
      <div className=" min-w-[100%]  mb-[24px] rounded dark:bg-brandDark1">
        <div className="px-[24px] py-[24px]">
          ...
          <div className="relative">
            ...
            <span className="absolute right-[0px] mw-lg:top-[22px] top-[24px] bg-brand  flex items-center justify-center montserratfont text-brandLightOpacity100 h-[40px] w-[80px] mw-lg:h-[30px] mw-lg:w-[72px] mw-lg:text-[14px] font-medium text-base">
              LEAKS
            </span>
          </div>
