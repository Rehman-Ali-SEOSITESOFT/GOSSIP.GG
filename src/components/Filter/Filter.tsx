...
const Filter = () => {
  const images = [
    { l_pic: l_pc, d_ac_pic: d_a_pc, pic: pc, name: "Laptops" },
    { l_pic: l_mobile, d_ac_pic: d_a_mobile, pic: mobile, name: "Laptops" },
    { l_pic: L_console, d_ac_pic: d_a_console, pic: console, name: "Laptops" },
  ];
