              ...
              >
                <div className="choiceModelMain">
                  ...
                  <div className="titlesection text-center">
                    <h3 className="font-bold montserratfont text-2xl leading-7	text-brandLightOpacity100 pb-3.5	mw-sm:text-xl	">
                      Choose topics to follow.
                    </h3>
                    <p className="montserratfont text-brandLightOpacity70 text-base	leading-5">
                  ...
                  >
                    <div className="slectopitons overflow-scroll overflow-x-hidden scrollbar-thin	scrollbar-thumb-custom2 scrollbar-track-custom rounded h-[450px] flex flex-wrap ">
                      {items.map((e, i) => {
                        return (
                          <div
