  ...
  return (
    <>
      ...
      >
        ...
        />
        <span className="absolute montserratfont text-[21px] leading-[25.6px] font-bold text-[#E5E5E5] px-[16px] py-[9px] bg-[#ED4E50] bottom-[18px] mw-lg:text-[18px]  rounded-r-lg mw-md:top-[8px] mw-md:bottom-auto mw-sm:text-[14px]">
          {props.qty}
        </span>
