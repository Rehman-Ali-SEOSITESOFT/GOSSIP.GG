  ...
  return (
    <div className="w-full max-w-[1440px] pl-[100px]  pr-[54px] mx-13:pl-[70px] mx-13:pr-[50px] mw-xl:pl-[50px]  mw-xl:pr-[40px]  mw-lg:pl-[16px] mw-lg:pr-[16px]  m-auto ">
      <div className="flex justify-between w-full">
            ...
            {items.map((elem, index) => {
              return (
                <div
                  ...
                  } pl-5 pr-5 pb-0  mw-lg:w-full flex ${
                ...
                >
                  ...
                  >
                    <h4
                      className={` text-base leading-5 text-brandDark2 font-bold montserratfont dark:text-brandLightOpacity100 `}
                    >
        ...
        <div className="w-full max-w-[416px] h-[345px] flex flex-col justify-between">
          <div className="flex justify-between border  border-grayCard dark:border-brandLightOpacity10 rounded p-2.5 pr-[7px]">
            ...
            <div className="contentside flex justify-between flex-col h-[145px] pl-4 mt-[-8px]">
              ...
              <div className="border-t  border-grayCard dark:border-brandLightOpacity10 flex justify-end items-center pt-[8px] ">
