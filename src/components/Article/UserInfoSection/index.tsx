...
const UserLogoSection = () => {
  ...
  return (
    <div className="global-section-width-article ">
         ...
         <div className="flex flex-row mw-lg:flex-col mw-lg:mt-[20px]  items-center justify-between pt-[40px] pb-[40px]">
          <div className=" flex items-center">
            ...
            <div className="ml-[12px]">
                <p className="montserratfont dark:text-brandLightOpacity100 text-brandDark2 text-[18px] font-bold " >John William</p>
                <div className="flex flex-row">
                    <p className="montserratfont  text-brand text-[18px] font-bold ">Esports Writer</p>
                    <Image src={isDarkTheme === "dark" ?  DarkLogo  :textIconColor } alt="logo"/>
                </div>
                <div className="flex flex-row">
                    <Image src={Insta} className="dark:brightness-100 brightness-0" alt="Instagram"/>
                    <Image className="ml-[16px] dark:brightness-100 brightness-0" src={Twitter} alt="Twitter"/>
                    <Image className="ml-[16px] dark:brightness-100 brightness-0" src={Mail} alt="mail"/>
                    <Image className="ml-[16px] dark:brightness-100 brightness-0" src={LinkedIn} alt="LinkedIn"/>
                </div>
            </div>
          </div>
          <div className="mw-lg:mt-[20px] border-l-[2px] dark:border-l-brand border-l-brandDark2 ">
            <p className="mw-sm4:text-[10px] max-w-[638px] mw-sm:text-[12px] mw-sm1:text-[14px] pl-[16px] text-left montserratfont text-base dark:text-brandLightOpacity100 text-brandDark2">
              John  is a professional Dota 2 player and a winner of multiple championships. He has been a freelance Esports journalist since 2013.professional Dota 2 player  and a winner of multiple championships. He has been a freelance Esports journalist since 2013.
            </p>
      ...
      <div className=" flex flex-row  mt-[26px]  max-w-[968px] mw-lg:justify-between">
      <div className="shared-icons flex items-center ">
            ...
            <div className="my-[22px] mw-lg:ml-[0px] ml-[318px] item-iamge-arrows text-center flex flex-row   items-center">
