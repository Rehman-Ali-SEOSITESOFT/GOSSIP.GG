...
// import image2 from "../../../assets/esportsevents2/image2.png";
...
const NewGossipPosting = () => {
  ...
  return (
    <>
      <section className="mw-9:w-[100%]">
        <div className=" min-w-[100%] mb-[24px] rounded bg-white dark:bg-brandDark1 ">
          <div className="px-[28px] py-[28px] mw-md:py-[16px] mw-md:px-[10px]">
            <p className="montserratfont mw-lg:text-[14px] font-bold  text-brandDark2 dark:text-brandLightOpacity100 text-[24px] mw-md:text-[20px] mw-sm:text-[14px]">
            ...
            <div className="relative">
              <Image className="my-[24px] w-[100%]" src={Post1} alt="post" />
        ...
        <div className=" min-w-[100%]  mb-[24px] rounded bg-white  dark:bg-brandDark1">
          <div className="px-[28px] py-[28px] mw-md:py-[16px] mw-md:px-[10px]">
            <p className="montserratfont font-bold mw-lg:text-[14px] text-brandDark2 dark:text-brandLightOpacity100 text-[24px] mw-md:text-[20px] mw-sm:text-[14px]">
              Bayes Esports appoints York Scheunemann as COO of their company
            </p>
            <small className="pt-[16px] mw-sm1:hidden">
              <a
            ...
            <Image className="my-[24px] w-[100%]" src={Post2} alt="post" />
            <div className=" flex flex-row justify-between border-t border-b dark:border-t-brandLightOpacity10 dark:border-b-brandLightOpacity10">
              <div className="my-[22px] item-iamge-arrows text-center flex flex-row items-center">
                <div className="up-arrow bg-grayCard dark:bg-brandLightOpacity10 dark:hover:bg-brandLightOpacity20 w-[32px] h-[32px] flex items-center justify-center rounded-3xl cursor-pointer  hover:bg-borderEditProfile">
                  <Image
        ...
        <div className=" min-w-[100%]  mb-[24px] rounded bg-white dark:bg-brandDark1">
          <div className="px-[28px] py-[28px] mw-md:py-[16px] mw-md:px-[10px]">
            ...
            <Image className="my-[24px] w-[100%]" src={Post3} alt="post" />
            <div className=" flex flex-row justify-between border-t border-b dark:border-t-brandLightOpacity10 dark:border-b-brandLightOpacity10">
              <div className="my-[22px] item-iamge-arrows text-center flex flex-row items-center">
                <div className="up-arrow bg-grayCard dark:bg-brandLightOpacity10 dark:hover:bg-brandLightOpacity20 w-[32px] h-[32px] flex items-center justify-center rounded-3xl cursor-pointer  hover:bg-borderEditProfile">
                  <Image
...
export default NewGossipPosting;
