...
const WelcomeGossip = (props: any) => {
  ...
  return (
    <Transition.Root show={props.welcomeGoggip} as={Fragment}>
      <Dialog
        as="div"
                ...
                <div className="choiceModelMain text-center">
                  <div className="choiceheader pb-4 float-right">
                    <div
                      ...
                      onClick={() => props.welcomGossipModel()}
                    >
                  ...
                  <div className={` flex flex-col  py-8	`}>
                    <a className="done_btn w-300px bg-brand inline-block py-3	rounded-3xl	text-center m-auto text-lg	leading-6	mb-6 text-brandLightOpacity100	font-bold montserratfont cursor-pointer mw-sm:w-[250px]   mw-sm3:w-[100%] mw-sm:text-base mw-sm:text-semibold ">
                      Continue
                    </a>
