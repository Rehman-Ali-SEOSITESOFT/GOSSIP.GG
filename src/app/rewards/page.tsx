  ...
  return (
    <>
      <section className="rewards_page_mian_wrapper">
        <div className="global-section-width border-b border-grayCard dark:border-brandLightOpacity10 p-0 mw-lg:bg-bodycolor mw-lg:dark:bg-brandDark2 mw-lg:z-[8]	overflow-x-auto">
          <div className="2xl-container">
            <div className="quiz_timing_wrapper">
              {/* <div className="bg-brandLightOpacity10 rounded-[20px] flex 	w-full overflow-x-auto	">
                <div className="">
                  <p>
              ...
              <div
                className={`bg-brandLightOpacity10 rounded-[20px] pb-[9px] pt-[9px] pl-[22px] pr-[22px]  mt-[7px] mb-[32px] flex w-full justify-start flex-nowrap overflow-x-auto`}
              >
                <div>
